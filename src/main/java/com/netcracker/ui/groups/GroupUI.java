...
public class GroupUI extends VerticalLayout {
    ...
    public GroupUI(BigInteger groupId) {
        ...
        GroupType curGroupType = concreteGroupType(groupId);
//        if(curGroupType == null)
//            curGroupType.setGroupType("PRIVATE_GROUP");
        ...
        if (curGroupType.getGroupType() != null && curGroupType.getGroupType().equals("PUBLIC_GROUP")) {
            //MAIN
...
//            addComponents(headerLayout, mainLayout);
    ...
    private GridLayout getPhotosGrid(List<Profile> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            String curAvatar = list.get(i).getProfileAvatar();
    ...
    private GroupType concreteGroupType(BigInteger groupId) {
